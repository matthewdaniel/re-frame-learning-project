 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__36283){
...
var event_id = cljs.core.nth.call(null,vec__36288,(0),null);
var _ = cljs.core.nth.call(null,vec__36288,(1),null);
...
var map__36292__$1 = ((((!((map__36292 == null)))?((((map__36292.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36292.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36292):map__36292);
var m = map__36292__$1;
var unregister = cljs.core.get.call(null,map__36292__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.call(null,map__36292__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.call(null,map__36292__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.call(null,map__36292__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var post_event_callback_fn = ((function (events_preds,_,___$1,map__36292,map__36292__$1,m,unregister,register,events,dispatch_to,id__GT_listen_fn){
return (function (event_v,___$2){
if(cljs.core.truth_(cljs.core.some.call(null,((function (events_preds,_,___$1,map__36292,map__36292__$1,m,unregister,register,events,dispatch_to,id__GT_listen_fn){
return (function (pred){
return pred.call(null,event_v);
});})(events_preds,_,___$1,map__36292,map__36292__$1,m,unregister,register,events,dispatch_to,id__GT_listen_fn))
,events_preds))){
...
return cljs.core.map_indexed.call(null,(function (index,p__36294){
...
var rule = map__36295__$1;
var id = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var halt_QMARK_ = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__36297){
...
var id = cljs.core.get.call(null,map__36298__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.call(null,map__36298__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.call(null,map__36298__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.call(null,map__36298__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
var set_state = (cljs.core.truth_(db_path)?((function (_,local_store,map__36298,map__36298__$1,id,db_path,rules,first_dispatch){
...
});})(_,local_store,map__36298,map__36298__$1,id,db_path,rules,first_dispatch))
:((function (_,local_store,map__36298,map__36298__$1,id,db_path,rules,first_dispatch){
return (function (db,seen,started){
...
var get_state = (cljs.core.truth_(db_path)?((function (_,local_store,set_state,map__36298,map__36298__$1,id,db_path,rules,first_dispatch){
return (function (db){
return cljs.core.get_in.call(null,db,db_path);
});})(_,local_store,set_state,map__36298,map__36298__$1,id,db_path,rules,first_dispatch))
:((function (_,local_store,set_state,map__36298,map__36298__$1,id,db_path,rules,first_dispatch){
return (function (___$1){
return cljs.core.deref.call(null,local_store);
});})(_,local_store,set_state,map__36298,map__36298__$1,id,db_path,rules,first_dispatch))
);
var rules__$1 = day8.re_frame.async_flow_fx.massage_rules.call(null,rules);
return ((function (_,local_store,set_state,get_state,rules__$1,map__36298,map__36298__$1,id,db_path,rules,first_dispatch){
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_hander(p__36300,p__36301){
var map__36302 = p__36300;
...
var db = cljs.core.get.call(null,map__36302__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__36303 = p__36301;
var ___$1 = cljs.core.nth.call(null,vec__36303,(0),null);
var event_type = cljs.core.nth.call(null,vec__36303,(1),null);
var event_v = vec__36303;
var pred__36307 = cljs.core._EQ_;
var expr__36308 = event_type;
if(cljs.core.truth_(pred__36307.call(null,new cljs.core.Keyword(null,"setup","setup",1987730512),expr__36308))){
...
var vec__36310 = event_v;
var ___$2 = cljs.core.nth.call(null,vec__36310,(0),null);
var forwarded_event = cljs.core.nth.call(null,vec__36310,(1),null);
var map__36313 = get_state.call(null,db);
...
var seen_events = cljs.core.get.call(null,map__36313__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.call(null,map__36313__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
;})(_,local_store,set_state,get_state,rules__$1,map__36298,map__36298__$1,id,db_path,rules,first_dispatch))
});
/**
...
var vec__36315 = day8.re_frame.async_flow_fx.ensure_has_id.call(null,flow);
var id = cljs.core.nth.call(null,vec__36315,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__36315,(1),null);
...
//# sourceMappingURL=async_flow_fx.js.map?rel=1521239471653
