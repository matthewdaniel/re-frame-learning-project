...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__32584 = cljs.core.instance_QMARK_;
var expr__32585 = reactive_val;
if(cljs.core.truth_(pred__32584.call(null,reagent.ratom.RAtom,expr__32585))){
return "ra";
} else {
if(cljs.core.truth_(pred__32584.call(null,reagent.ratom.RCursor,expr__32585))){
return "rc";
} else {
if(cljs.core.truth_(pred__32584.call(null,reagent.ratom.Reaction,expr__32585))){
return "rx";
} else {
if(cljs.core.truth_(pred__32584.call(null,reagent.ratom.Track,expr__32585))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1521903528658
