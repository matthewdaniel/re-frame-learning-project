...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__32413 = cljs.core.instance_QMARK_;
var expr__32414 = reactive_val;
if(cljs.core.truth_(pred__32413.call(null,reagent.ratom.RAtom,expr__32414))){
return "ra";
} else {
if(cljs.core.truth_(pred__32413.call(null,reagent.ratom.RCursor,expr__32414))){
return "rc";
} else {
if(cljs.core.truth_(pred__32413.call(null,reagent.ratom.Reaction,expr__32414))){
return "rx";
} else {
if(cljs.core.truth_(pred__32413.call(null,reagent.ratom.Track,expr__32414))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1521239467413
