...
var or__28458__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj38713 = {"detail":data};
return obj38713;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28446__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28446__auto__)){
var and__28446__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__38720 = cljs.core._EQ_;
var expr__38721 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38720.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38721))){
return ((function (pred__38720,expr__38721){
return (function (p1__38714_SHARP_){
return console.warn(p1__38714_SHARP_);
});
;})(pred__38720,expr__38721))
} else {
if(cljs.core.truth_(pred__38720.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38721))){
return ((function (pred__38720,expr__38721){
return (function (p1__38715_SHARP_){
return console.debug(p1__38715_SHARP_);
});
;})(pred__38720,expr__38721))
} else {
if(cljs.core.truth_(pred__38720.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38721))){
return ((function (pred__38720,expr__38721){
return (function (p1__38716_SHARP_){
return console.error(p1__38716_SHARP_);
});
;})(pred__38720,expr__38721))
} else {
return ((function (pred__38720,expr__38721){
return (function (p1__38717_SHARP_){
return console.log(p1__38717_SHARP_);
});
;})(pred__38720,expr__38721))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38724){
...
var opts = map__38725__$1;
var eval_fn = cljs.core.get.call(null,map__38725__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38727_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__38729,(0),null);
var v = cljs.core.nth.call(null,vec__38729,(1),null);
...
if(cljs.core.truth_((function (){var and__28446__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1521903536464
