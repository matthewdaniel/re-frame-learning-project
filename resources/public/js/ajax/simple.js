...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__33851){
...
var handler = cljs.core.get.call(null,map__33852__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__28458__auto__ = p1__33854_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__33855){
...
var request = map__33856__$1;
var interceptors = cljs.core.get.call(null,map__33856__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__28458__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__28458__auto__)){
return or__28458__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1521903530745
