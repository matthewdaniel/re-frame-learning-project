...
return (new CustomEvent(event_name,(function (){var obj37422 = {"detail":data};
return obj37422;
})()));
} else {
...
var f = (function (){var pred__37429 = cljs.core._EQ_;
var expr__37430 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37429.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37430))){
return ((function (pred__37429,expr__37430){
return (function (p1__37423_SHARP_){
return console.warn(p1__37423_SHARP_);
});
;})(pred__37429,expr__37430))
} else {
if(cljs.core.truth_(pred__37429.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37430))){
return ((function (pred__37429,expr__37430){
return (function (p1__37424_SHARP_){
return console.debug(p1__37424_SHARP_);
});
;})(pred__37429,expr__37430))
} else {
if(cljs.core.truth_(pred__37429.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37430))){
return ((function (pred__37429,expr__37430){
return (function (p1__37425_SHARP_){
return console.error(p1__37425_SHARP_);
});
;})(pred__37429,expr__37430))
} else {
return ((function (pred__37429,expr__37430){
return (function (p1__37426_SHARP_){
return console.log(p1__37426_SHARP_);
});
;})(pred__37429,expr__37430))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37433){
...
var opts = map__37434__$1;
var eval_fn = cljs.core.get.call(null,map__37434__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37436_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37438,(0),null);
...
}catch (e37443){if((e37443 instanceof Error)){
var e = e37443;
return not_found;
} else {
throw e37443;
...
//# sourceMappingURL=utils.js.map?rel=1521239472888
