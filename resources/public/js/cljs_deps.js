...
goog.addDependency("../simple/events.js", ['simple.events'], ['ajax.core', 'day8.re_frame.async_flow_fx', 'cljsjs.moment', 'goog.string', 'cljs.core', 'cljs_http.client', 'cljs.core.async', 'camel_snake_kebab.core', 'cljs.pprint', 're_frame.core', 'day8.re_frame.http_fx']);
goog.addDependency("../simple/views/batch_items.js", ['simple.views.batch_items'], ['cljsjs.moment', 'reagent.core', 'cljs.core', 'cljs.pprint', 'clojure.string', 're_frame.core']);
...
goog.addDependency("../simple/views/fields.js", ['simple.views.fields'], ['cljsjs.moment', 'simple.views.field_types.text', 'reagent.core', 'cljs.core', 'simple.views.field_types.html', 'cljs.pprint', 'simple.views.field_types.upc', 'clojure.string', 're_frame.core']);
goog.addDependency("../simple/core.js", ['simple.core'], ['simple.views', 'simple.events', 'reagent.core', 'cljs.core', 'simple.views.batch_items', 'simple.views.fields', 'cljs.pprint', 'clojure.string', 're_frame.core']);
